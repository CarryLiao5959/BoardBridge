...
class ProcInfoEarly :public InfoStrategy {
public:
    virtual void sendInfo(Info& info) {
        log_debug("ProcInfoEarly InfoStrategy");
...
const string ProcInfoEarly::cmd = "ps -eo pid,ppid,comm,state,stime | head -n 20";
const string ProcInfoEarly::dirname = "info/";
const string ProcInfoEarly::filename = "proc.json";